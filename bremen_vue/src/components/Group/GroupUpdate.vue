    ...
    <div class="group-create">
        ...
        <form class="create-form">
            <div>
                ...
                <input v-model="store.group.groupTitle" type="text" required class="create-text">
            </div>
            <div>
                <div class="group-text">내용</div>
                <textarea v-model="store.group.groupContent" :rows="calculateTextareaRows(store.group.groupContent)" required class="create-text"></textarea>
            </div>

            <div>
                <div class="group-text">모집 인원</div>
                <input v-model="store.group.groupMaxPeople" type="number" required class="create-text">
            </div>

            <div>
                <div class="group-text">날짜</div>
                <input v-model="store.group.groupDate" type="date" required class="create-text">
            </div>

            <div>
                <div class="group-text">시간</div>
                <input v-model="store.group.groupTime" type="time" required class="create-text">
            </div>

            <button class="create-button" @click="update">수정</button>
        </form>
    </div>
</template>
