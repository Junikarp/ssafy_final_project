<template>
  ...
  <div type="button" class="card" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
    ...
    <table class="board-table">
      <tbody>
        <DetailQuestion v-for="boardItem in store.boardList" :key="boardItem.boardId" :dynamic-props="boardItem" data-aos="fade-up" data-aos-duration="1000"></DetailQuestion>
      </tbody>
    </table>
</template>
